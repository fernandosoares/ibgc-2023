            ...
            <div class="accordion mb-4" id="accordion-programacao">
                ...
                <div class="accordion-item mb-5">
                    <h2 class="accordion-header" id="primeiro-dia">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-primeiro-dia" aria-expanded="true" aria-controls="collapse-primeiro-dia">
                            <p>
                                Dia 1<br />
                    ...
                    <div id="collapse-primeiro-dia" class="accordion-collapse collapse" aria-labelledby="primeiro-dia" data-bs-parent="#accordion-programacao">
                        <div class="accordion-body">
                            ...
                            <div class="row schedule-item">
                                ...
                                <div class="col-12 col-md-10">
                                    <p class="title">Feira de negócios</p>
                                    <p class="flag presencial">Presencial</p>
                                </div>
                            </div>
                            <div class="row schedule-item">
                                ...
                                <div class="col-12 col-md-10">
                                    ...
                                    <div class="topic-container b-gray py-2">
                                        ...
                                        <p class="desc"> - Moderação: Vicky Bloch, sócia diretora da Vicky Bloch Associados.</p>
                                    </div>
                                ...
                                <div class="col-12 col-md-10">
                                    ...
                                    <div class="topic-container b-black py-2">
                                        ...
                                        <p class="desc"> - Joana Setzer, professora e pesquisadora no Grantham Research
                                            Institute on Climate Change and the Environment, da London School of
                                            Economics</p>
                                        <p class="desc"> - Moderação: José Pugas, líder do comitê consultivo do Chapter Zero
                            ...
                            <div class="row schedule-item">
                                <div class="col-12 col-md-2 mt-1">15h50</div>
                                <div class="col-12 col-md-10">
                            ...
                            <div class="row schedule-item">
                                ...
                                <div class="col-12 col-md-10">
                                    ...
                                    <p class="desc"> - Moderação: Glaucy Bocci, Senior Client Partner &amp; Board Services COE
                                        Member da Korn Ferry</p>
                                    <p class="flag presencial">Presencial</p>
                                    <p class="flag online">On-line</p>
                                </div>
                            </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="segundo-dia">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-segundo-dia" aria-expanded="true" aria-controls="collapse-segundo-dia">
                            <p>
                                Dia 2<br />
                    ...
                    <div id="collapse-segundo-dia" class="accordion-collapse collapse" aria-labelledby="segundo-dia" data-bs-parent="#accordion-programacao">
                        <div class="accordion-body">
                            ...
                            <div class="row schedule-item">
                                <div class="col-12 col-md-2 mt-1">8h40</div>
                                <div class="col-12 col-md-10">
                            ...
                            <div class="row schedule-item">
                                <div class="col-12 col-md-2 mt-1">15h20</div>
                                <div class="col-12 col-md-10">
